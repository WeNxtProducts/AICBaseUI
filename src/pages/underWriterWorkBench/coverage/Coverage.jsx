        ...
        <div className='coverage_details mt-4 p-3'>
            ...
            <div className='grid grid-cols-12 gap-1 mt-2'>
                <div className={`col-span-${10} mr-2 accordion_conatiner`}>
                    ...
                    >
                        <MRVData queryId={199} tranId={policyNumber} heading='Riders' />
                    </CustomAccordion>
                    <CustomAccordion
                        title='Loading'
                    ...
                    >
                        <MRVData queryId={26} tranId={tranId} heading='Loading' />
                    </CustomAccordion>
                    <CustomAccordion
                        title='Discount'
                    ...
                    >
                        <MRVData queryId={25} tranId={tranId} heading='Discount' />
                    </CustomAccordion>
                    <CustomAccordion
                        title='Charges'
                    ...
                    >
                        <MRVData queryId={148} tranId={tranId} heading='Charges' />
                    </CustomAccordion>
                    <CustomAccordion
                        title='BrokerAgent'
                    ...
                    >
                        <MRVData queryId={204} tranId={tranId} heading='Broker/Agent' />
                    </CustomAccordion>
                </div>
