...
const EndorementListing = ({
    ...
    return (
        <div className='MRV_card pe-1'>
            {tableData?.map((item, index) => (
                <div
                    data-id={item?.[highlightKey]}
                    key={item?.[highlightKey]}
                    className={selectedRow == item?.[highlightKey] ? 'list_card_highlighted_row mb-2' : 'list_card mb-2'}>
                    <div
...
export default EndorementListing;
