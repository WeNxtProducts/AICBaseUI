...
const EndoListing = ({ label, search: searchApi }) => {
    ...
    const deleteEndo = useApiRequests('deleteEndo', 'DELETE');
    ...
    const handleDeleteConfirm = async () => {
        setLoader(true);
        try {
            const response = await deleteEndo('', {}, { tranId: deleteId?.ID });
            setDeleteId(null);
        ...
        <div className='common-listing-screen mt-2'>
            ...
            <div className='custmer-search flex items-end justify-between'>
                <div className='w-full'>
                    <p className='search-title'>Endorsement List</p>
