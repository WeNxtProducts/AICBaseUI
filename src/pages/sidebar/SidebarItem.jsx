      ...
      <div className={open ? 'sidebar-item open cursor-pointer' : 'sidebar-item cursor-pointer'}>
        <div
          ...
          <span className='ml-3 children-menu'>
            {item?.menuIconPath && (
              <i
                className={`${item?.menuIconPath} ${menuSelected?.includes(item?.menuId) ? 'icon-color-selected' : 'icon-color'
                  }`}></i>
            )}
            <span
              //  onClick={() => handleMenuSelected()}
    ...
    return (
      <div className='sidebar-item sidebar-item-sub plain'>
        <div
          ...
          className={`sidebar-title-sub cursor-pointer ${menuSelected && menuSelected.includes(item?.menuId)
          ...
          <span className='ml-3 children-menu'>
            ...
            <span
              ...
              <Tooltip title={item?.menuOptionDesc}>
                {item?.menuOptionDesc}
              </Tooltip>
            </span>
          </span>
